  ...
  const heroChips = useMemo(
    () => ({
      ...
      highlights: [
        ...
        "Status updates & media sharing"
      ],
      stats: [
        { label: "Encryption", value: "AES / RSA" },
        { label: "Instant login", value: "< 10s" },
        { label: "Media types", value: "All" },
        { label: "Calls", value: "Free" }
      ]
    }),
    []
  );
  ...
  return (
    <Motion.div
      className={[
        ...
        "dark:from-slate-950 dark:via-slate-950 dark:to-rose-950/30"
      ].join(" ")}
      initial="hidden"
      animate="visible"
    ...
    >
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 opacity-70 dark:opacity-30 bg-[radial-gradient(1100px_circle_at_15%_10%,rgba(225,29,72,0.15),transparent_40%),radial-gradient(900px_circle_at_85%_20%,rgba(251,113,133,0.12),transparent_40%),radial-gradient(900px_circle_at_50%_90%,rgba(244,63,94,0.08),transparent_45%)]" />
        <div className="absolute inset-0 bg-[linear-gradient(to_bottom,rgba(255,255,255,0.5),rgba(255,255,255,0.0))] dark:bg-[linear-gradient(to_bottom,rgba(2,6,23,0.85),rgba(2,6,23,0.0))]" />
      </div>

      {/* ── Mobile hero banner ── */}
      <div className="lg:hidden relative overflow-hidden bg-gradient-to-br from-rose-600 via-rose-500 to-pink-500 px-6 pt-10 pb-8">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-16 -right-16 h-48 w-48 rounded-full bg-white/10 blur-2xl" />
          <div className="absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-white/10 blur-2xl" />
        </div>
        <div className="relative">
          <div className="inline-flex items-center gap-2 rounded-full bg-white/20 px-3 py-1.5 text-xs font-bold text-white mb-4">
          ...
          <div className="flex flex-wrap gap-2">
            {["🔒 E2E Encrypted", "⚡ Instant", "😍 Reactions"].map(t => (
      ...
      <div className="relative mx-auto flex lg:h-[100dvh] w-full max-w-6xl lg:items-center lg:justify-center p-4 sm:p-6 lg:p-8">
        <Motion.div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 lg:h-[820px] lg:max-h-[85vh] min-h-0">
            ...
            <div className="relative hidden lg:flex flex-col justify-between p-8 xl:p-10 border-r border-rose-100/40 dark:border-slate-800/40 bg-gradient-to-br from-rose-600 via-rose-500 to-pink-500">
              <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-l-[28px]">
                ...
                <div className="absolute bottom-[-80px] left-16 h-72 w-72 rounded-full bg-rose-300/20 blur-3xl" />
              ...
              <div className="relative flex h-full flex-col justify-between">
                <div className="space-y-5">
                  ...
                  {/* Chat illustration */}
                  <div className="flex flex-col gap-2.5 rounded-2xl bg-white/15 backdrop-blur-sm border border-white/20 p-4">
                    <div className="flex items-end gap-2">
                      <div className="h-7 w-7 rounded-full bg-white/30 flex items-center justify-center text-white text-xs font-bold shrink-0">A</div>
                      <div className="rounded-2xl rounded-bl-sm bg-white/90 px-3 py-2 text-xs text-slate-700 shadow-sm max-w-[75%]">
                        Hey! Did you see the new feature? 👀
                        <div className="mt-0.5 text-[10px] text-slate-400">10:41 AM</div>
                      </div>
                    </div>
                    <div className="flex items-end gap-2 justify-end">
                      <div className="rounded-2xl rounded-br-sm bg-white/25 border border-white/30 px-3 py-2 text-xs text-white shadow-md max-w-[75%]">
                        Yes! End-to-end encrypted too 🔒✨
                        <div className="mt-0.5 text-[10px] text-white/70 flex items-center justify-end gap-1">10:42 AM ✓✓</div>
                      </div>
                    </div>
                    <div className="flex items-end gap-2">
                      <div className="h-7 w-7 rounded-full bg-white/30 flex items-center justify-center text-white text-xs font-bold shrink-0">A</div>
                      <div className="rounded-2xl rounded-bl-sm bg-white/90 px-3 py-2 text-xs text-slate-700 shadow-sm">
                        Love this app! 😍❤️
                        <div className="mt-0.5 text-[10px] text-slate-400">10:42 AM</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-2 pl-9">
                      <div className="flex items-center gap-1 rounded-full bg-white/20 px-2.5 py-1.5">
                      ...
                      <span className="text-[10px] text-white/70">Ana is typing...</span>
                    </div>
                  </div>

                  <div className="grid grid-cols-2 gap-2">
                    {heroChips.stats.map((s) => (
                      <div key={s.label} className="rounded-2xl bg-white/15 border border-white/20 px-3 py-2.5">
                        <div className="text-[10px] font-bold tracking-wider uppercase text-white/60">{s.label}</div>
            ...
            <div className="flex flex-col h-full min-h-0 overflow-y-auto p-5 sm:p-8 xl:p-10 pb-10">
                      ...
                      {loading ? (
                        <span className="flex items-center gap-2">
                          <span className="flex gap-1">
                            <span className="h-2 w-2 rounded-full bg-white/80 animate-bounce [animation-delay:0ms]"/>
                             ...
                             {loading ? (
                               <span className="flex items-center gap-2">
                                 <span className="flex gap-1">
                                   ...
                                   <span className="h-1.5 w-1.5 rounded-full bg-white/80 animate-bounce [animation-delay:120ms]"/>
                                   <span className="h-1.5 w-1.5 rounded-full bg-white/80 animate-bounce [animation-delay:240ms]"/>
                                 </span>
                                 Creating...
                               </span>
                             ) : (
              ...
              <div className="mt-6 pb-4 text-center text-sm text-slate-600 dark:text-slate-300">
                <button
                  ...
                  className="font-semibold text-rose-600 hover:text-rose-700 dark:text-rose-400 dark:hover:text-rose-300 underline underline-offset-2"
                >
